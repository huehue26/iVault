  ...
  return (
    <main className="p-8">
      <section className="mb-8">
        <div>
          <h1 className="text-4xl font-bold text-brand-gray-600">Assigned Claims</h1>
          <p className="text-gray-700 mt-1">Manage and process claims assigned to you</p>
        </div>
      </section>

      <section className="bg-white p-6 rounded-xl shadow-sm">
        <h2 className="text-xl font-bold text-brand-gray-600 mb-6">Your Assigned Claims</h2>
        ...
        <div className="space-y-2 mt-4">
          {rows.map((r) => (
            <div key={r.id}
              ...
              onClick={() => {
                setActiveClaimId(r.id);
                setActivePage("claimManagementDetailsPage");
              }}
            >
